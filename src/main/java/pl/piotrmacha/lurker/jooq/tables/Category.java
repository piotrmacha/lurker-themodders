...
public class Category extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    /**
     * The column <code>public.category.url</code>.
     */
    public final TableField<CategoryRecord, String> URL = createField(DSL.name("url"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    /**
     * The column <code>public.category.parent</code>.
     */
    public final TableField<CategoryRecord, String> PARENT = createField(DSL.name("parent"), SQLDataType.CLOB, this, "");
    ...
    public List<ForeignKey<CategoryRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CATEGORY__CATEGORY_PARENT_FKEY);
    }
    ...
    public CategoryPath category() {
        if (_category == null)
            _category = new CategoryPath(this, Keys.CATEGORY__CATEGORY_PARENT_FKEY, null);
    ...
    public ThreadPath thread() {
        if (_thread == null)
            _thread = new ThreadPath(this, null, Keys.THREAD__THREAD_CATEGORY_FKEY.getInverseKey());
